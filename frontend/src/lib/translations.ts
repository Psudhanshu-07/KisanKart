...
export const translations = {
  en: {
    ...
    home: {
      badge: "Public marketplace for farmers and consumers",
      title: "Fresh produce, direct from the farm",
      description: "KisanKart is a transparent marketplace where farmers and FPOs list fruits and vegetables, consumers buy directly, and payment is settled through verified farmer or FPO payment details without platform fees.",
      browseProduce: "Browse Produce",
      farmerLogin: "Farmer / FPO Login",
      marketplaceStatus: "Marketplace status",
      emptyTitle: "No products listed yet",
      emptyDescription: "The marketplace is intentionally empty at launch so farmers and FPOs can list fresh produce as soon as they are ready. Consumers will see live stock when sellers add listings.",
      builtForTrust: "Built for trust",
      simpleExperiences: "Simple experiences for farmers and buyers",
      farmerAccount: "Farmer / FPO account",
      farmerDescription: "Create a trusted seller profile, add payment details, list produce with transparent pricing, and receive direct payments without platform fees.",
  ...
  hi: {
    ...
    home: {
      badge: "किसानों और उपभोक्ताओं के लिए सार्वजनिक मंडी",
      title: "खेत से सीधे ताज़ी उपज",
      description: "किसानकार्ट एक पारदर्शी मंडी है जहां किसान और एफपीओ फल-सब्जियां सूचीबद्ध करते हैं, उपभोक्ता सीधे खरीदते हैं और भुगतान सत्यापित भुगतान विवरण के माध्यम से होता है।",
      browseProduce: "उपज देखें",
      farmerLogin: "किसान / एफपीओ लॉगिन",
      marketplaceStatus: "मंडी की स्थिति",
      emptyTitle: "अभी कोई उत्पाद सूचीबद्ध नहीं है",
      emptyDescription: "मंडी को शुरुआत में खाली रखा गया है ताकि किसान और एफपीओ तैयार होने पर ताज़ी उपज सूचीबद्ध कर सकें। विक्रेता सूची जोड़ने के बाद उपभोक्ताओं को उपलब्ध स्टॉक दिखेगा।",
      builtForTrust: "विश्वास के लिए बनाया गया",
      simpleExperiences: "किसानों और खरीदारों के लिए सरल अनुभव",
      farmerAccount: "किसान / एफपीओ खाता",
      farmerDescription: "विश्वसनीय विक्रेता प्रोफाइल बनाएं, भुगतान विवरण जोड़ें, पारदर्शी कीमत पर उपज सूचीबद्ध करें और सीधे भुगतान प्राप्त करें।",
      createFarmer: "किसान खाता बनाएं",
  ...
  mr: {
    ...
    home: {
      badge: "शेतकरी आणि ग्राहकांसाठी सार्वजनिक बाजारपेठ",
      title: "शेतातून थेट ताजा शेतमाल",
      description: "किसानकार्ट ही पारदर्शक बाजारपेठ आहे जिथे शेतकरी आणि एफपीओ फळे-भाज्या सूचीबद्ध करतात, ग्राहक थेट खरेदी करतात आणि सत्यापित पेमेंट तपशीलांद्वारे पैसे दिले जातात.",
      browseProduce: "शेतमाल पहा",
      farmerLogin: "शेतकरी / एफपीओ लॉगिन",
      marketplaceStatus: "बाजारपेठेची स्थिती",
      emptyTitle: "अजून कोणताही माल सूचीबद्ध नाही",
      emptyDescription: "शेतकरी आणि एफपीओ तयार झाल्यावर ताजा शेतमाल सूचीबद्ध करू शकतील म्हणून सुरुवातीला बाजारपेठ रिकामी ठेवली आहे. विक्रेत्यांनी माल जोडल्यावर ग्राहकांना उपलब्ध साठा दिसेल.",
      builtForTrust: "विश्वासासाठी तयार",
      simpleExperiences: "शेतकरी आणि खरेदीदारांसाठी सोपा अनुभव",
      farmerAccount: "शेतकरी / एफपीओ खाते",
      farmerDescription: "विश्वसनीय विक्रेता प्रोफाइल तयार करा, पेमेंट तपशील जोडा, पारदर्शक दराने शेतमाल सूचीबद्ध करा आणि थेट पैसे मिळवा.",
      createFarmer: "शेतकरी खाते तयार करा",
